...
var BaseClient = __webpack_require__(/*! ./client */ "../node_modules/browserstack/lib/client.js");
var extend = __webpack_require__(/*! ./extend */ "../node_modules/browserstack/lib/extend.js");
...
var browserstackApi = __webpack_require__(/*! ./api */ "../node_modules/browserstack/lib/api.js");
var browserstackAutomate = __webpack_require__(/*! ./automate */ "../node_modules/browserstack/lib/automate.js");
var browserstackAppAutomate = __webpack_require__(/*! ./app-automate */ "../node_modules/browserstack/lib/app-automate.js");
var browserstackScreenshot = __webpack_require__(/*! ./screenshot */ "../node_modules/browserstack/lib/screenshot.js");
...
var extend = __webpack_require__(/*! ./extend */ "../node_modules/browserstack/lib/extend.js");
var HttpsProxyAgent = __webpack_require__(/*! https-proxy-agent */ "../node_modules/https-proxy-agent/index.js");
var userAgent = getUA();

function getUA() {
	var os = __webpack_require__(/*! os */ "os");
	var version = __webpack_require__(/*! ../package.json */ "../node_modules/browserstack/package.json").version;
...
/***/ "./controllers/capture/Capture.controller.js":
/*!***************************************************!*\
  !*** ./controllers/capture/Capture.controller.js ***!
  \***************************************************/
/*! no static exports found */
...
const EnvironmentVariables = __webpack_require__(/*! dotenv */ "../node_modules/dotenv/lib/main.js");

const BrowserStack = __webpack_require__(/*! browserstack */ "../node_modules/browserstack/lib/browserstack.js");
...
class CaptureController {
  constructor() {
    ...
    this.captureScreenshot = (req, res) => __awaiter(this, void 0, void 0, function* () {
      const captureInput = req.body;
      yield this.browserStackCaptureScreenshot(captureInput).then(job => {
        res.send(job);
      }).catch(error => {
        res.status(503).send({
    ...
    this.browserStackCaptureScreenshot = captureInput => __awaiter(this, void 0, void 0, function* () {
      var options = {
...
const app_1 = __webpack_require__(/*! ./app */ "./app.js");

const bodyParser = __webpack_require__(/*! body-parser */ "../node_modules/body-parser/index.js");

const logger_1 = __webpack_require__(/*! ./middleware/logger */ "./middleware/logger.js");

const Capture_controller_1 = __webpack_require__(/*! ./controllers/capture/Capture.controller */ "./controllers/capture/Capture.controller.js");

const app = new app_1.default({
  port: 5000,
  controllers: [new Capture_controller_1.default()],
